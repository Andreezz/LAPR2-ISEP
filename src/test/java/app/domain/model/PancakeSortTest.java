...
class PancakeSortTest {
    ...
    void sort() {
        ...
        for(CenterData CD: testLeaveSort){
    ...
    void findMax(){
        ...
        CenterData cd3 = new CenterData("11/05/2020", "11:05", "11/05/2020", "11:05", "11/05/2020", "11:05",
                "13/05/2020", "11:05", "123456783", "21C16-05", "Spikevax", "first");
        ArrayList<CenterData> test = new ArrayList<>();
        test.add(cd1);
        test.add(cd2);
        test.add(cd3);
        int expected = 2;

        Assertions.assertEquals(expected, PancakeSort.findMax(test, 3, true));

        ArrayList<CenterData> testLeave = new ArrayList<>();
        testLeave.add(cd2);
        testLeave.add(cd1);
        testLeave.add(cd3);

        /*for(int i = 0;i< 3;i++){
            System.out.println(testLeave.get(i));
        }*/
        Assertions.assertEquals(expected, PancakeSort.findMax(testLeave, 3, false));
    }
